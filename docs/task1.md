...
- Records used in final sample: 35
...
- Attacking players were identified using FBref positions containing `FW`.
- Under 25 group: `Age < 25`.
- Age 28+ group: `Age >= 28`.
- Players aged 25, 26 and 27 were excluded from the comparison.
- Sampling method: Random sampling with a fixed random seed.
- Random seed: `137`.
...
|---|---:|---:|---:|---|
| Under 25 | 4.268 | 6.699 | 10 | 0.116 to 8.420 |
| Age 28+ | 4.307 | 9.149 | 25 | 0.721 to 7.893 |
...
There is not enough statistical evidence to conclude that the mean Shots/90 differs between the two age groups.
...
- Filtered dataset: `data/processed/processed1.csv`
